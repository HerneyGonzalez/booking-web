    ...
    <div className="footer">
      <div className="fLists">
        <ul className="fList">
          ...
          <li className="fListItem">Citios</li>
          <li className="fListItem">Distritos</li>
          <li className="fListItem">Aeropuertos</li>
          <li className="fListItem">Hoteles</li>
        </ul>
        <ul className="fList">
          <li className="fListItem">Viviendas </li>
          <li className="fListItem">Apartmentos </li>
          <li className="fListItem">Resorts </li>
          <li className="fListItem">Villas</li>
          <li className="fListItem">Hosteles</li>
        ...
        <ul className="fList">
          ...
          <li className="fListItem">Reservas en restaurantes </li>
        ...
        <ul className="fList">
          ...
          <li className="fListItem">centro de Prensa</li>
          <li className="fListItem">Centro de recursos de seguridad</li>
          <li className="fListItem">Terminos & condiciones</li>
        </ul>
      </div>
      <div className="fText">Copyright © 2024 RoadToRest.</div>
    </div>
  );
};
